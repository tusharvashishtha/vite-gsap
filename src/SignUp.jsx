    ...
    <div className='h-screen w-full flex flex-col lg:flex-row justify-center items-center bg-amber-900'>
      ...
      <div className='mobile-view h-full w-full flex flex-col justify-evenly items-center px-5 md:hidden'>
        ...
        <div className="loginPageFormContainer flex flex-col items-center mt-5 w-[90%] bg-[#F2D5C0] rounded-3xl p-5">
          ...
          <form className='w-full flex flex-col mt-5'>
            ...
            <input type="password" placeholder="Password" className='h-10 pl-5 mb-3 w-full bg-[#F8E4D5] rounded-full border-none focus:bg-white focus:outline-none' />
            <input type="password" placeholder="Confirm Password" className='h-10 pl-5 mb-3 w-full bg-[#F8E4D5] rounded-full border-none focus:bg-white focus:outline-none' />
      ...
      <div className='desktop-view hidden lg:flex lg:w-[100%] lg:h-[100%]  gap-5  justify-center px-5'>
        ...
        <div className='loginPage2Part h-full flex flex-col gap-5 justify-center w-[50%] items-center'>
          <div className="loginPageFormContainer flex flex-col items-center h-[40vw] w-[90%] overflow-hidden rounded-3xl bg-[#F2D5C0]">
            ...
            <div className='loginPage2Form w-full  h-[80%]'>
              <form className='w-full h-full flex flex-col justify-center items-center'>
                <div className='h-fit w-full flex flex-col items-center justify-center p-3 gap-4'>
                  <input type="text" placeholder="Enter your name" className='h-15 pl-5 w-[75%] bg-[#F8E4D5] rounded-full border-none focus:bg-white focus:outline-none' />
                  <input type="text" placeholder="Enter your email" className='h-15 pl-5 w-[75%] bg-[#F8E4D5] rounded-full border-none focus:bg-white focus:outline-none' />
                </div>
                <div className='h-fit w-full flex  items-center justify-center p-3 gap-4'>
                  <input type="password" placeholder="Password" className='h-15 pl-5 w-[35%] bg-[#F8E4D5] rounded-full border-none focus:bg-white focus:outline-none' />
                  <input type="text" placeholder="Confirm Password" className='h-15 pl-5 w-[35%] bg-[#F8E4D5] rounded-full border-none focus:bg-white focus:outline-none' />
                </div>
